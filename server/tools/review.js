...
// ── DYNAMIC TIMEOUT (Auto-Memory) ──
    ...
    // --- AGENT'S NEW SAFETY CHECKS ---
    if (!llmResponse) {
      console.error("❌ LLM response is null or undefined.");
      throw new Error("LLM review failed: Response is null or undefined.");
    }
    ...
    const reviewText = llmResponse.data?.text || "";
    ...
    if (reviewText.trim().length === 0) {
      return {
        ...
        success: false,
        final: true,
        error: "No review text generated by LLM."
      };
    }
    // ---------------------------------
